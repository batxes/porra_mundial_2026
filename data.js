window.PORRA_DATA = {
  ...
  // Official squad catalog imported from https://worldcupranking.com/world-cup-2026/squads/ on 2026-06-08.
  players: [
      {
          "id": "alg-01",
          "name": "Mastil",
  ...
  pointsRules: [
    { label: "Eleccion acertada", value: "+1" },
    { label: "Marcador exacto", value: "Goles del partido" },
    { label: "Gol delantero", value: "+2" },
    { label: "Gol centrocampista", value: "+6" },
    { label: "Gol defensa", value: "+11" },
    { label: "Gol portero", value: "+35" },
