...
export const trainerDemoCards: TrainerDemoCard[] = [
  {
    ...
    points: 97,
    role: "DT",
    artUrl: "/trainer-cards/brasil-ancelotti.webp",
    background:
  ...
  },
  {
    ...
    points: 96,
    role: "DT",
    artUrl: "/trainer-cards/espana-de-la-fuente.webp",
    background:
  ...
  },
  {
    ...
    points: 95,
    role: "DT",
    artUrl: "/trainer-cards/francia-deschamps.webp",
    background:
  ...
  createTrainerDemoCard({
    ...
    teamId: "mex",
    points: 94,
    artUrl: "/trainer-cards/mexico-aguirre.webp",
    primary: "#006847",
    secondary: "#ce1126",
    third: "#073b2b",
    light: "#f7f7f7",
  ...
  createTrainerDemoCard({
    ...
    teamId: "rsa",
    points: 83,
    artUrl: "/trainer-cards/sudafrica-broos.webp",
    primary: "#007a4d",
    secondary: "#ffb612",
    third: "#002395",
    light: "#f8fafc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "sui",
    points: 90,
    artUrl: "/trainer-cards/suiza-yakin.webp",
    primary: "#da291c",
    secondary: "#ffffff",
    third: "#70130f",
    light: "#fff5f5",
  ...
  createTrainerDemoCard({
    ...
    teamId: "can",
    points: 87,
    artUrl: "/trainer-cards/canada-marsch.webp",
    primary: "#d80621",
    secondary: "#ffffff",
    third: "#4b0b13",
    light: "#fff1f2",
  ...
  createTrainerDemoCard({
    ...
    teamId: "mar",
    points: 88,
    artUrl: "/trainer-cards/marruecos-ouahbi.webp",
    primary: "#c1272d",
    secondary: "#006233",
    third: "#5f1217",
    light: "#f6fff8",
  ...
  createTrainerDemoCard({
    ...
    teamId: "usa",
    points: 89,
    artUrl: "/trainer-cards/estados-unidos-pochettino.webp",
    primary: "#1d3f8f",
    secondary: "#b31942",
    third: "#071b4f",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "aus",
    points: 85,
    artUrl: "/trainer-cards/australia-popovic.webp",
    primary: "#00843d",
    secondary: "#ffcd00",
    third: "#052f21",
    light: "#f8fafc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "ger",
    points: 94,
    artUrl: "/trainer-cards/alemania-nagelsmann.webp",
    primary: "#111827",
    secondary: "#ffce00",
    third: "#dd0000",
    light: "#f8fafc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "civ",
    points: 84,
    artUrl: "/trainer-cards/costa-de-marfil-fae.webp",
    primary: "#f77f00",
    secondary: "#009e60",
    third: "#623412",
    light: "#fff7ed",
  ...
  createTrainerDemoCard({
    ...
    teamId: "ned",
    points: 93,
    artUrl: "/trainer-cards/paises-bajos-koeman.webp",
    primary: "#ff5a00",
    secondary: "#21468b",
    third: "#6a2500",
    light: "#fff7ed",
  ...
  createTrainerDemoCard({
    ...
    teamId: "jpn",
    points: 87,
    artUrl: "/trainer-cards/japon-moriyasu.webp",
    primary: "#1f4ea8",
    secondary: "#bc002d",
    third: "#061a44",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "bel",
    points: 91,
    artUrl: "/trainer-cards/belgica-garcia.webp",
    primary: "#111111",
    secondary: "#fae042",
    third: "#ed2939",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "egy",
    points: 85,
    artUrl: "/trainer-cards/egipto-hassan.webp",
    primary: "#ce1126",
    secondary: "#ffffff",
    third: "#111111",
    light: "#f8fafc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "cpv",
    points: 82,
    artUrl: "/trainer-cards/cabo-verde-bubista.webp",
    primary: "#003893",
    secondary: "#cf2027",
    third: "#f7d116",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "nor",
    points: 86,
    artUrl: "/trainer-cards/noruega-solbakken.webp",
    primary: "#ba0c2f",
    secondary: "#00205b",
    third: "#50101d",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "bih",
    points: 81,
    artUrl: "/trainer-cards/bosnia-barbarez.webp",
    primary: "#002f6c",
    secondary: "#f7d116",
    third: "#061a44",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "par",
    points: 83,
    artUrl: "/trainer-cards/paraguay-alfaro.webp",
    primary: "#d52b1e",
    secondary: "#0038a8",
    third: "#071b4f",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "ecu",
    points: 84,
    artUrl: "/trainer-cards/ecuador-beccacece.webp",
    primary: "#ffdd00",
    secondary: "#034ea2",
    third: "#ed1c24",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "swe",
    points: 84,
    artUrl: "/trainer-cards/suecia-potter.webp",
    primary: "#005293",
    secondary: "#fecb00",
    third: "#032b4f",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "sen",
    points: 85,
    artUrl: "/trainer-cards/senegal-thiaw.webp",
    primary: "#00853f",
    secondary: "#fdef42",
    third: "#e31b23",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "arg",
    points: 97,
    artUrl: "/trainer-cards/argentina-scaloni.webp",
    primary: "#74acdf",
    secondary: "#f6b40e",
    third: "#0b3d75",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "aut",
    points: 88,
    artUrl: "/trainer-cards/austria-rangnick.webp",
    primary: "#ed2939",
    secondary: "#ffffff",
    third: "#671019",
    light: "#fff5f5",
  ...
  createTrainerDemoCard({
    ...
    teamId: "alg",
    points: 84,
    artUrl: "/trainer-cards/argelia-petkovic.webp",
    primary: "#006233",
    secondary: "#d21034",
    third: "#073b2b",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "col",
    points: 90,
    artUrl: "/trainer-cards/colombia-lorenzo.webp",
    primary: "#ffcd00",
    secondary: "#003087",
    third: "#c8102e",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "por",
    points: 92,
    artUrl: "/trainer-cards/portugal-martinez.webp",
    primary: "#006600",
    secondary: "#ff0000",
    third: "#7f0012",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "cod",
    points: 82,
    artUrl: "/trainer-cards/rd-congo-desabre.webp",
    primary: "#00a3e0",
    secondary: "#f7d618",
    third: "#ce1021",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "eng",
    points: 93,
    artUrl: "/trainer-cards/inglaterra-tuchel.webp",
    primary: "#f8fafc",
    secondary: "#cf142b",
    third: "#1f3a68",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "cro",
    points: 89,
    artUrl: "/trainer-cards/croacia-dalic.webp",
    primary: "#f43f5e",
    secondary: "#ffffff",
    third: "#1d4ed8",
    light: "#ffffff",
  ...
  createTrainerDemoCard({
    ...
    teamId: "gha",
    points: 83,
    artUrl: "/trainer-cards/ghana-queiroz.webp",
    primary: "#006b3f",
    secondary: "#fcd116",
    third: "#ce1126",
    light: "#fff7cc",
  ...
  createTrainerDemoCard({
    ...
    teamId: "",
    points: 0,
    artUrl: "/trainer-cards/placeholder-coach.webp",
    primary: "#27272a",
    secondary: "#a1a1aa",
    third: "#09090b",
    light: "#f4f4f5",
