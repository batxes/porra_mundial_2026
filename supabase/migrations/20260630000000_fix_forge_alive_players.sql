-- Reafirma que la Forja no puede devolver jugadores eliminados en playoffs.
-- Mantiene la regla de puesto: si las 4 cartas son del mismo puesto intenta una
-- estrella viva de ese puesto; si no existe, cae a cualquier estrella viva.
