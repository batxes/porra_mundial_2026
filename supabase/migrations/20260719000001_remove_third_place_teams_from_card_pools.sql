-- Al terminar el partido por el tercer puesto, tanto el tercero como el cuarto
-- dejan de jugar. Los dos deben salir de los pools de cartas; no solo el
