-- Los perdedores de semifinal no están eliminados de todos los partidos:
-- ambos disputan el tercer puesto. Deben seguir siendo elegibles para los
-- sobres hasta que ese partido termine.
